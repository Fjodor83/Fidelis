// Fidelity.Server/Controllers/TransazioniController.cs
            ...
            [FromBody] AssegnaPuntiRequest request)
        {
            ...
            try
            {
                ...
                int puntoVenditaId = ruolo == "Admin"
                    ? 0 // Service will derive from Customer if 0, or logic needs adjustment. 
                    // Service logic: "PuntoVenditaId = puntoVenditaId > 0 ? puntoVenditaId : (cliente.PuntoVenditaRegistrazioneId ?? 0)"
                    // So if Admin passes 0, it uses Customer's PV. Correct.
